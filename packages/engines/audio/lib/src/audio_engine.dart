...
class AudioReaderEngine extends ReaderEngine {
  static const Set<String> _formats = <String>{'audio', 'w3caudiobook'};
...
class _AudioStubSession extends ReaderSession {
  _AudioStubSession({
    required Book book,
  ...
  @override
  Set<ReaderCapability> get capabilities => AudioReaderEngine._capabilities;
