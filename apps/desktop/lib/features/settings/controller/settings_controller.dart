...
class SettingsController extends StateNotifier<SettingsState> {
  ...
  Future<void> load() async {
    ...
    try {
      ...
      state = state.copyWith(
        isLoading: false,
        errorMessage: 'Load settings failed: $error',
      );
    }
  }
  ...
  Future<void> updateApp(AppSettings next) async {
    ...
    try {
      ...
      state = previous.copyWith(
        errorMessage: 'Save app settings failed: $error',
      );
    }
  }
  ...
  Future<void> updateReader(ReaderSettings next) async {
    ...
    try {
      ...
      state = previous.copyWith(
        errorMessage: 'Save reader settings failed: $error',
      );
    }
  }
  ...
  Future<void> updateCloud(CloudOptions next) async {
    ...
    try {
      ...
      state = previous.copyWith(
        errorMessage: 'Save cloud settings failed: $error',
      );
    }
  }
